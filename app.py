...
Финальная версия: восстановлены ВСЕ колонки таблицы (длины, позиции), 
сохранён интерактивный BLAST, поиск генов-мишеней и In-Silico PCR.
"""
        ...
        if seq_input:
            ...
            if not is_valid:
                ...
                if st.session_state.primers_df is not None and not st.session_state.primers_df.empty:
                    ...
                    # Прямой вывод таблицы, подготовленной в utils.py, без лишних фильтраций
                    st.dataframe(
                        df_disp,
