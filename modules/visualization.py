...
def create_primer_map(
    ...
    """Создаёт красивую интерактивную карту позиций праймеров со стрелками."""
    ...
    fig.add_trace(go.Scatter(
        ...
        hoverinfo="text",
        text=[f"Старт: 1 п.н.", f"Конец: {seq_length} п.н."],
    ))
    ...
    for idx, pair_idx in enumerate(selected_pairs):
        ...
        # right_start это 5' конец реверса (самая правая координата).
        hover_rev = (
        ...
        fig.add_vrect(
            ...
            line_width=1,
            line_dash="dot",
            annotation_text=f"<b>Ампликон {p.product_size} bp</b>",
    ...
    fig.update_layout(
        ...
        height=400 + len(selected_pairs) * 45,
        plot_bgcolor="white",
        paper_bgcolor="white",
