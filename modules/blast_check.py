...
class BlastHit:
    ...
    match_seq: str = ""
    subject_seq: str = ""
    # Поле для очищенного имени гена
...
class SpecificityResult:
    ...
    warning_message: str = ""
    error_message: str = ""
    # Множество целевых генов, которые амплифицирует праймер
    ...
    for attempt in range(max_retries):
        try:
            ...
            for alignment in blast_record.alignments:
                ...
                # Извлекаем чистое название гена из огромного заголовка NCBI
                ...
                for hsp in alignment.hsps:
                    ...
                    # Если хит сильный, добавляем его в список потенциальных мишеней (генов)
